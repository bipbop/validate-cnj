(function (global, factory) {
    ...
    */
    ...
    var require$$0 = ( wcwidth$1 && wcwidth_1 ) || wcwidth$1;
    ...
    var lib = function(text, length, options) {
      ...
      padlength = options.fixed_width ? length - (textnocolors || text).length : length - wcwidth$2(textnocolors || text, options.wcwidth_options);
      if (padlength < 0) {
        if (options.strip) {
          if (invert) {
